#' @title Sample Data for Small Area Estimation using Hierarchical Bayesian Method for Rao Yu Model
#'
#' @description Dataset to simulate Small Area Estimation using Hierarchical Bayesian Method for Rao Yu Model
...
#' \item Calculate \eqn{\mu_{ij}=\beta_{0}+\beta_{1}xdi1_{ij}+\beta_{2}xdi2_{ij}+v_{i}+u_{ij}+e_{ij}}
